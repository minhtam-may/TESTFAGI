...
<body id="page-top">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            {{-- <a class="nav-link dropdown-toggle" href="/admin/user" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" role="dialog">
                            ...
                            @if(Auth::check())
                                <a href="/admin/logout" class="login-panel">
    ...
    <script src="admin_assets/admin_assets/vendor/jquery/jquery.min.js"></script>
