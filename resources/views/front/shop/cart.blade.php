                ...
                <div class="col-md-4">
                    ...
                    <div class="single-sidebar">
                        ...
                        <div class="thubmnail-recent">
                            <img src="front/img/product-1.jpg" class="recent-thumb" alt="">
                            <h2><a href="/shop/product/1">Samsung A35</a></h2>
                            <div class="product-sidebar-price">
                                <ins>$495.00</ins> <del>$629.29</del>
                            </div>                             
                        </div>
                        <div class="thubmnail-recent">
                            <img src="front/img/product-2.jpg" class="recent-thumb" alt="">
                            <h2><a href="/shop/product/2">Nokia 3</a></h2>
                            <div class="product-sidebar-price">
                                <ins>$13.00</ins> <del>$35.00</del>
                            </div>                             
                        </div>
                        <div class="thubmnail-recent">
                            <img src="front/img/product-5.jpg" class="recent-thumb" alt="">
                            <h2><a href="/shop/product/5">Iphone 6</a></h2>
                            <div class="product-sidebar-price">
                                <ins>$35.00</ins> <del>$44.00</del>
                            </div>                             
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="cart_item">
                                            <td class="product-remove">
                                                <a title="Remove this item" class="remove" href="{{ route('cart.remove', $cart->rowId) }}">×</a> 
                                            </td>

                                            <td class="product-thumbnail">
                                                <a href="shop/product/{{ $cart->id }}"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="front/img/{{ $cart->options->images[0]->path }}"></a>
                                            </td>
                                            ...
                                            <td class="product-quantity">
                                                <div class="quantity buttons_added">
                                                    ...
                                                    {{-- <input type="number" name="[qty]" size="4" class="input-text qty text" title="Qty" value="{{ $cart->qty }}" min="0" step="1"> --}}
                                                    {{-- <input type="button" class="plus" value="+"> --}}
                                                    <input type="number" name="items[{{ $cart->rowId }}][qty]" value="{{ $cart->qty }}" min="1" step="1"class="form-control" >
                                ...
                                <ul class="products">
                                    ...
                                    <li class="product">
                                        <a href="/shop/product/2">
                                            ...
                                            <h3>Nokia 3</h3>
                                            <span class="price">$13.00 <del class="amount">$35.00</del></span> 
                                        </a>
                                    ...
                                    <li class="product">
                                        <a href="single-product.html">
                                            <img width="325" height="325" alt="T_4_front" class="attachment-shop_catalog wp-post-image" src="front/img/product-1.jpg">
                                            <h3>Samsung A35</h3>
                                            <span class="price">$495.00 <del class="amount">$629.29</del></span>
                                        </a>

                                        <a class="add_to_cart_button" data-quantity="1" data-product_sku="" data-product_id="22" rel="nofollow" href="cart/add/1">Add to cart</a>
                                    </li>
                                </ul>
                            </div>
